...
export function Leaderboard() {
  // TODO Part 1: initialise state with SEED_COHORTS.
  //              Sort by amountRaised descending and display as a ranked table.
  //              Each row: rank, class name, lead volunteer, formatted amount
  //              raised, donor count, and percentage of goal.
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      {/* TODO: sort controls and search input */}

      {/* TODO: leaderboard rows */}
